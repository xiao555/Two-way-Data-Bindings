...
/***/ function(module, exports) {
	...
	exports.getValue = function getValue(route, obj) {
	  var keys = route.match(/(\w+\.?)+/g)[0].split('.');
	  var value = obj;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toArray = __webpack_require__(15).toArray;
	var directives = __webpack_require__(47);
	...
	Compile.prototype.splitElement = function (node) {
	  ...
	  if (node.hasChildNodes()) {
	    (0, _from2.default)(node.childNodes).forEach(this.analyElement, this);
	  }
	};
	...
	Compile.prototype.replaceElement = function (node) {
	  ...
	  var tokens = this.getTokens(regTag, text);
	
	  var frag = document.createDocumentFragment();
	  tokens.forEach(function (token) {
	    var el = token.tag ? self.processTextToken(token) : document.createTextNode(token.value);
	    frag.appendChild(el);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getRoute = __webpack_require__(15).getRoute;
	...
	Observer.prototype.convert = function (key, val, parents) {
	  var self = this;
	  var target = parents == [] ? this._data : getRoute(this._data, parents);
	  var dep = new Dep();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getValue = __webpack_require__(15).getValue;
	var setValue = __webpack_require__(15).setValue;
	var Dep = __webpack_require__(31);
	...
	Watcher.prototype.get = function () {
	  Dep.target = this;
	  var value = getValue(this.expression, this.vm._data);
	  Dep.target = null;
	  return value;
	};
